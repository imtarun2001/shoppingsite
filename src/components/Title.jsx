...
//     isLoggedIn,
//     gotoDashboard,
//     gotoDashboardNLogOut,
//     gotoLogIn,
//     gotoSignUp,
//   } = useContext(AppContext);

//   return (
//     <div className="fixed top-0 right-0 z-50 w-full flex justify-between items-center px-36 py-2 gap-36 bg-blue-800">
//       <div className="flex items-center gap-4">
//         <button
//           className="flex items-center gap-1 font-bold text-[17px] px-3 py-1 rounded-md bg-black text-white hover:bg-aliceblue hover:text-black transition"
//           onClick={gotoCart}
//         >
//           Cart <BsCart4 />
//           <div className="relative -bottom-2 left-1 text-pink-700">{cartProducts.length}</div>
//         </button>
//         <button
//           className="flex items-center gap-1 font-bold text-[17px] px-3 py-1 rounded-md bg-black text-white hover:bg-aliceblue hover:text-black transition"
...
//         >
//           Wishlist <MdFavorite />
//           <div className="relative -bottom-2 left-1 text-pink-700">{wishListProducts.length}</div>
//         </button>
//       </div>

//       <div
//         className="text-[30px] font-serif cursor-pointer"
//         style={{
//           background: 'linear-gradient(180deg, #ff8d01, #efdd54)',
